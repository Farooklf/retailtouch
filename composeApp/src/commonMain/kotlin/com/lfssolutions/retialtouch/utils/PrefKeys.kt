...
object PrefKeys {
    ...
    const val CURRENT_TENANT_URL = "currentTenantUrl"
    ...
    const val SALE_INVOICE_PREFIX= "salesInvoicePrefix"
    const val NEXT_SALE_INVOICE_NUMBER= "nextSalesInvoiceNumber"
    const val MEMBER_SYNC= "memberSync"
    const val MEMBER_GROUP_SYNC= "memberGroupSync"
    const val TERMINAL_CODE = "terminalCode"
    const val PRODUCT_SYNC= "productsSync"
    const val CATEGORY_SYNC= "categorySync"
